...
class ResumeServiceTest {
    ...
    static class FakeAIProvider implements AIProvider {
        ...
        @Override
        public String generateQuestions(String role, String resumeContext, String guidance, String levelDifficulty, int hr, int tech, int proj, int count, String avoidList) { return response; }
        @Override
