...
function VoiceRecorder({ onRecordingComplete, disabled, autoStart, onRecordingStart, onRecordingStop, forceStop }) {
...
useEffect(() => {
  ...
  useEffect(() => {
    if (disabled) {
      console.log("[RECORDING_DISABLED]");
      if (isRecording) {
        stopRecording();
      }
    } else {
      console.log("[RECORDING_ENABLED]");
    }
